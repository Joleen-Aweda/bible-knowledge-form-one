# Bible Knowledge for Secondary Schools Student’s Book Form One — ADT Bundle Reference
...
**Bible Knowledge for Secondary Schools Student’s Book Form One** — This is an English-language Bible Knowledge textbook for Form One secondary school students in Tanzania, published by the Tanzania Institute of Education under the 2023 syllabus. It introduces the Bible, its structure, authorship and languages, then focuses mainly on Genesis through themes such as creation, the fall of man, Noah, the Tower of Babel, and the patriarchs Abraham, Isaac, Jacob and Joseph. The book is aimed at early secondary learners and uses a strongly moral and faith-based teaching approach, linking biblical stories to everyday life, character formation, citizenship, family life, communication, and environmental care.

- **Source language**: `en-KE`
- **Available languages in this bundle**: `en-KE`
- **Total pages**: 80
- **Glossary**: yes
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: en-KE
...
├── BIBLE-KNOWLDEGE-FORM-ONE.db                    # SQLite database (pipeline state)
├── BIBLE-KNOWLDEGE-FORM-ONE.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg001_im008` |
...
{
  "pg001_gp001_tx001": "",
  "pg001_im008": "The United Republic of Tanzania Ministry of Education,",
  "gl001": "abomination",
  "gl001_def": "something considered extremely wrong or hateful, especially before God"
}
```
...
```json
{
  "abomination": {
    "word": "abomination",
    "definition": "something considered extremely wrong or hateful, especially before God",
    "variations": ["abomination","abominations"],
    "emoji": "⛔😠"
  }
}
```
...
```json
{
  "title": "Bible Knowledge for Secondary Schools Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-KE"
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg001_im008" src="images/pg001_im008.png" ...>
...
| Original PDF | `BIBLE-KNOWLDEGE-FORM-ONE.pdf` |
| Pipeline database | `BIBLE-KNOWLDEGE-FORM-ONE.db` (SQLite) |
